...
impl Comps {
    ...
    fn bootstrap(&self) {
        self.add("", "param", Profile::new("comp", hashmap!{
            "id" => TgpValue::Iden("param"),
            "type" => TgpValue::Iden("param"),
            "params" => TgpValue::Array(vec![TgpValue::Iden("id"), TgpValue::Iden("type"), TgpValue::Iden("defaultValue")]),
        }));
        self.add("", "primitiveType", Profile::new("comp", hashmap!{
            "id" => TgpValue::Iden("tgpType"),
            "type" => TgpValue::Iden("tgpType"),
            "params" => TgpValue::Array(vec![TgpValue::Iden("id")]),
...
// pub trait TgpTypeI : Any + Send + Sync {
...
//     is_array: bool
// }
// impl TgpTypeI for BasicTgpType {
//     fn is_of_type(&self, parent: &dyn TgpTypeI) -> bool { self.as_string() == parent.as_string() }
//     fn as_string(&self) -> StaticString { self.id }
